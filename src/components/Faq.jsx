...
function Faq() {
  ...
  return (
    <div className="bg-backgroundColor px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 py-16 sm:py-24 md:py-32 lg:py-40">
      <h1 className="font-bold text-white text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-center">
        FAQ
      </h1>
