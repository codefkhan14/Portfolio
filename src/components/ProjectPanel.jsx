...
function ProjectPanel({ cssClass }) {
  return (
    <>
     ...
     <h2>Our Projects</h2>
   <p className="project-p">Here are some of my projects. These projects showcase my work and skills that i've tried to put to use in real world applications. These projects help me learn and grow as a developer.</p>
     <div className="projects-list">
      ...
      <div className="card">
        ...
        <div className={`card-body ${cssClass}`}>
          ...
          Inter is a club, it's a vibrant community where technology enthusiasts come together.
          </p>
          <div className="project-btn">
            <a href="https://github.com/codefkhan14/Inter-Club" target="_blank" className="btn btn-primary">
              Github
            </a>
            <a href="https://interccslub.netlify.app/" target="_blank"className="btn btn-primary">
              Live Demo
            </a>
          </div>
        </div>
      ...
      <div className="card">
        ...
        <div className={`card-body ${cssClass}`}>
          ...
          <p className="card-text">
          Bandhej Hub" is an ecommerce platform specializing in bandhani products
          </p>
          <div className="project-btn">
      ...
      <div className="card">
        ...
        <div className={`card-body ${cssClass}`}>
          ...
          <p className="card-text">
          A Portfolio website, where i have presented myself and showcase my skills projects and more.
          </p>
          <div className="project-btn">
            <a href="https://github.com/codefkhan14/Portfolio" target="_blank" className="btn btn-primary">
              Github
            </a>
            <a href="https://codefkhan14.github.io/Portfolio/" target="_blank" className="btn btn-primary">
              Live Demo
            </a>
          </div>
        </div>
